...
export default function TopicPracticePage() {
  ...
  const handleBack = () => {
    router.push(`/roadmap/topic/${topicId}`)
  }
    ...
    return (
      <div className="min-h-screen bg-black text-white p-6 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-4">Please sign in to practice problems.</p>
    ...
    return (
      <div className="min-h-screen bg-black text-white p-6 flex items-center justify-center">
        <div className="text-center max-w-md">
          <AlertCircle className="w-12 h-12 text-red-400 mx-auto mb-4" />
          <h2 className="text-xl font-semibold mb-2">Error Loading Practice</h2>
    ...
    return (
      <div className="min-h-screen bg-black text-white p-6 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400 mb-4">The requested topic could not be found.</p>
          <Button onClick={() => router.push('/roadmap')} className="bg-blue-600 hover:bg-blue-700">
            Back to Roadmap
          </Button>
        </div>
